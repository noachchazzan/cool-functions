 ...
 ***to avoid: 
 1. use lets/conts, never var. 
 2. function expressions, avoid declaratiosn when possible.
 3. functions come first calling the function comes last. 
 4. variables come first first.
 varaubles first, functions 2nd and invokations last 
function hoist() {
...
The primitive data types, as a refresher, are: string, number, bigint, boolean, undefined, symbol, null.*/
let myVar = 20; 
function passBy(x) {
    x = x * 10;
}
